...
from model_3d_cnn_2_1 import AttentionCNNTransformer_2_1
...
class CNN3DTrainer:
    ...
    def create_model(self, dropout_rate=0.25):
        ...
        if self.model_type == 'cnn':
            ...
            model = AttentionCNNTransformer_2_1(
                in_channels=28, 
                    ...
                    if self_attention_layers:
                        ...
                        for layer_name, layer_data in self_attention_layers.items():
                            if isinstance(layer_data, dict):
                                ...
                                # 💡 Interpretation hints for feature_diversity (with consistent formatting)
                                if feature_div != 'N/A' and isinstance(feature_div, (int, float)):
                                    if feature_div < 0.0005:
                                        ...
                                        print(f"        └─ ✅ Good head diversity ({feature_div:.4f}) - heads are specializing")
                                else:
...
def parse_arguments():
    ...
    # Data parameters
    parser.add_argument('--box-grids-size', type=float, default=20.0,
                       help='Voxel grid size')
    parser.add_argument('--box-increment', type=float, default=1.0,
