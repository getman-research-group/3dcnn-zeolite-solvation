...
- Reduced BatchNorm layers and simplified CBAM kernels (5x5x5 -> 3x3x3)
...
class AttentionCNNTransformer_2_6(nn.Module):
    """
    ...
    def __init__(self, in_channels=28,  # Changed default from 15 to 28 for type_2 format
        ...
        super(AttentionCNNTransformer_2_6, self).__init__()
        ...
        # 🔥 SIMPLIFIED: Removed layer4 to reduce architecture complexity
        # Final output: 80 channels instead of 96
        ...
        if self.use_transformer:
            self.vision_transformer = VisionTransformer3D(
                input_dim=80,  # Updated from 96 to 80 due to removed layer4
            ...
            classifier_input_dim = 80 * 3 * 3 * 3  # Updated flattened features = 2160 (was 2592)
    ...
    def forward(self, x, monitor_activations=False, detailed_analysis=None, feature_channels=None):
        ...
        # 🔥 SIMPLIFIED: Removed layer4 - direct to adaptive pooling
        # Final CNN features: (batch, 80, 5, 5, 5)
        
        # Adaptive pooling to 3x3x3 for better feature preservation
        x = self.adaptive_pool(x)  # (batch, 80, 3, 3, 3)
        if monitor_activations:
