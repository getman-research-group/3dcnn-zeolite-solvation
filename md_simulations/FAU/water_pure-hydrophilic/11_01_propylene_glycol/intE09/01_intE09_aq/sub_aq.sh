#/bin/bash 
#PBS -N adl11_01_propylene_glycol
#PBS -l select=1:ncpus=24:mpiprocs=24:mem=120gb:interconnect=fdr,walltime=72:00:00
#PBS -q work1 
#PBS -j oe
#PBS -m n
...
cd ${cwd}
# sed -i "s/PROJECT_NAME/${filename}/" sub_aq.sh	
...
mpirun -n 24 cp2k.popt -i ${NAME}.inp -o ${NAME}.out
